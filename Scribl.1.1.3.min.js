...
!0;else if(!this.hide){var c=this.getDrawStyle();b=this.chart.laneSizes;var d=this.lanes,e=this.chart.laneBuffer,f=this.chart.trackBuffer,g=b+f,h=this.chart.ctx;if(!a)if(c==void 0||c=="expand")for(b=0;b<d.length;b++)d[b].y=g,d[b].draw()&&(a=d[b].getHeight(),h.translate(0,a+e),g=g+a+e);else if(c=="collapse"){g=[];for(b=0;b<d.length;b++)g=g.concat(d[b].features);g.sort(function(a,b){return a.position-b.position});for(b=0;b<g.length;b++)a=g[b].length,c=g[b].name,g[b].draw(),g[b].length=a,g[b].name=c;
d.length>0&&h.translate(0,d[0].getHeight()+e)}else if(c=="line"){this.coverageData=[];this.coverageData.length==0&&this.calcCoverageData();g=this.maxDepth;h.beginPath();for(a=this.chart.offset;a<=this.chart.width+this.chart.offset;a++)c=this.coverageData[a]/g*b||0,c=b-c,h.lineTo(a,c);h.lineTo(this.chart.width+this.chart.offset,b);h.stroke();h.translate(0,d[0].getHeight()+e)}h.translate(0,f-e)}},addDrawHook:function(a,b){var c=b||_uniqueId("drawHook");this.hooks[c]=a;return c},removeDrawHook:function(a){delete this.hooks[a]}});var Lane=Class.extend({init:function(a,b){this.height=void 0;this.features=[];this.ctx=a;this.track=b;this.chart=b.chart;this.uid=_uniqueId("lane")},addGene:function(a,b,c,d){return this.addFeature(new BlockArrow("gene",a,b,c,d))},addProtein:function(a,b,c,d){return this.addFeature(new BlockArrow("protein",a,b,c,d))},addFeature:function(a){a.lane=this;this.features.push(a);this.chart[a.type]||(this.chart[a.type]={text:{}});if(a.length+a.position>this.chart.scale.max||!this.chart.scale.max)this.chart.scale.max=
