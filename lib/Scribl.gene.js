	...
	function Gene(ctx, position, length, height, strand) {
		...
		this.getColor = function() {
			...
			if ( this.track.chart.gene_color != undefined)
				this.color = this.track.chart.gene_color;
			else
		...
		this.getRoundness = function() { 
			...
			if ( this.track.chart.roundness != undefined )
				roundness = this.track.chart.roundness;
			else
