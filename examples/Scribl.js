	...
	function Scribl(canvas, width, svg) {
		...
		this.drawSVG = function() {
				...
				// }
					...
					.attr("d", function(d) { 
						...
						var height = d.track.chart.trackSizes;
						...
						if (bs_ctrl_x < x ) {
							...
							// bottom right corner
							svgString += " L" + brc_lgth_x + " " + brc_lgth_y;
							svgString += " Q" + brc_ctrl_x + " " + brc_ctrl_y + " " + brc_wdth_x + " " + brc_wdth_y;

							// top right corner
							svgString += " L" + trc_wdth_x + " " + trc_wdth_y;
					    svgString += " Q" + trc_ctrl_x + " " + trc_ctrl_y + " " + trc_lgth_x + " " + trc_lgth_y;

							// top line
							svgString += " L" + tc_lgth_x + " " + tc_lgth_y;
	...
	//				.attr("fill-opacity", .5)
					...
					.on("mouseout", function() { vis.select(".tooltip").remove()})
		}
