...
include the js files in the html
 ...
 <html lang="en">
	<head>
		<script src="https://github.com/chmille4/Scribl/raw/v0.2.1/Scribl.min.js" ></script>
...
The {closure compiler}[http://code.google.com/closure/compiler/] is used to combine and minify multiple javascript files.
 ...
 --js lib/Scribl.js \
 --js lib/Scribl.events.js \
 --js lib/Scribl.glyph.js \
 --js lib/Scribl.blockarrow.js \
 --js lib/Scribl.rect.js \
 --js lib/genbank.js \
